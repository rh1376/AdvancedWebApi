...
using CleanArchitecture.Domain.Utilities.Assert;
...
public class ApplicationDbContextInitialiser
{
    ...
    {
        // Default roles
        var administratorRole = new IdentityRole<int>("Admin");
        ...
        // Default users
        var administrator = new ApplicationUser { UserName = "admin@localhost", Email = "admin@localhost", FirstName = "admin", LastName = "admin" };
